	...
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			},
			{
				...
				"values": {
					"type": "crt.MenuItem",
					"caption": "#ResourceString(MenuItem_vb18c27_caption)#",
					"visible": true,
					"clicked": {
		...
		handlers: /**SCHEMA_HANDLERS*/[
			{
				...
				handler: async (request, next) => {
					...
					var typeObject = await request.$context.LookupAttribute_uj2f5yo;
					var typeId = "";
					if (typeObject) {
					...
					var offerTypeObject = await request.$context.LookupAttribute_wd3b1ay;
					var offerTypeId = "";
					if (offerTypeObject) {
